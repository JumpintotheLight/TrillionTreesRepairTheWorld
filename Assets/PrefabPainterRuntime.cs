...
{
    public class PrefabPainterRuntime : MonoBehaviour //: EditorWindow
    {
        //Vector2 scrollPos;
        ...
        [SerializeField]
        PaintPaletteRuntime activePalette;
        List<PaintPaletteRuntime> palettes = new List<PaintPaletteRuntime>();
        bool creatingNewPalette = false;
        public float SizeInterval = 0.10f;
        public bool displayOverrideWarning = true;

        // Prefab List
        PaintObjectRuntime selectedPrefab;
        ...
        public List<PaintObjectRuntime> PaintObjectRuntimes;
        bool isPainting;
        ...
        void OnEnable()
        {
            ...
            if (PaintObjectRuntimes == null) PaintObjectRuntimes = new List<PaintObjectRuntime>();
        ...
        //        if (path.Length != 0)
        //        {
        //            activePalette = (PaintPaletteRuntime)AssetDatabase.LoadAssetAtPath(path, typeof(PaintPaletteRuntime));
        ...
        //    DisplayPrefabs(PaintObjectRuntimes);
        ...
        //void OverridePalette(PaintPaletteRuntime palette)
        //{
        //    palette.palette = PaintObjectRuntimes;
        //}

        //void LoadPalette(PaintPaletteRuntime palette)
        //{
        //    listSize = palette.palette.Count;
        //    PaintObjectRuntimes = palette.palette;
        //    bool missingPrefabs = false;
        //    for (int i = 0; i < listSize; i++)
        //    {
        //        if (PaintObjectRuntimes[i].GetGameObject() == null) missingPrefabs = true;
        //    }
        ...
        //{
        //    listSize = 0;
        //    PaintObjectRuntimes = new List<PaintObjectRuntime>();
        //}
        ...
        //    string relativePath = "";
            ...
            //{
            //    PaintPaletteRuntime asset = ScriptableObject.CreateInstance<PaintPaletteRuntime>();
            //    asset.palette = PaintObjectRuntimes;
        ...
        //void AddMenuItemForPalette(GenericMenu menu, string menuPath, PaintPaletteRuntime palette)
        //{
        ...
        //{
        //    LoadPalette((PaintPaletteRuntime)palette);
        //    activePalette = (PaintPaletteRuntime)palette;
        //    creatingNewPalette = false;
        //}
        ...
        void CheckForChanges(float tempSize, int tempDensity)
        {
            ...
            else if (PaintObjectRuntimes != null && listSize != PaintObjectRuntimes.Count)
            {
                List<PaintObjectRuntime> tempObj = new List<PaintObjectRuntime>(listSize);
                for (int i = 0; i < listSize; i++)
                {
                    if (PaintObjectRuntimes.Count > i) tempObj.Add(PaintObjectRuntimes[i]);
                    else tempObj.Add(new PaintObjectRuntime(null));
                }

                PaintObjectRuntimes = new List<PaintObjectRuntime>(tempObj);
            }
        }
        ...
        void Painting()
        {
            if (PaintObjectRuntimes != null && PaintObjectRuntimes.Count > 0)
            {
        ...
        {
            int rndIndex = Random.Range(0, PaintObjectRuntimes.Count);
            GameObject prefabObj = PaintObjectRuntimes[rndIndex].GetGameObject();
            GameObject go = null;
            if (prefabObj != null)
            {
            ...
            //    Undo.RegisterCreatedObjectUndo(go, "Prefab Paint");
                ...
                bool randomRotationX = PaintObjectRuntimes[rndIndex].getRandomRotationX();
                bool randomRotationY = PaintObjectRuntimes[rndIndex].getRandomRotationY();
                bool randomRotationZ = PaintObjectRuntimes[rndIndex].getRandomRotationZ();
                ...
                Vector2 scale = PaintObjectRuntimes[rndIndex].getSize();
        ...
        public void DisplayPrefabs(List<PaintObjectRuntime> prefabs)
        {
        ...
        //                        PaintObjectRuntime po = new PaintObjectRuntime(go);
        //                        po.setName(dragged_object.name);
        //                        PaintObjectRuntimes.Add(po);
        //                        listSize++;
        //                    }
        //                }
        //            }
