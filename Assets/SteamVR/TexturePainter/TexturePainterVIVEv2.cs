...
public enum TexturePainter_BrushModev2 { PAINT, DECAL };


public class TexturePainterVIVEv2 : MonoBehaviour
{
   ...
   // public RaycastHit hitInfo;
    ...
    TexturePainter_BrushModev2 mode; //Our painter mode (Paint brushes or decals)
    ...
    void DoAction()
    {
        ...
        if (HitTestUVPosition(ref uvWorldPosition))
        {
            ...
            Debug.Log("HitTestUVPosition: " + uvWorldPosition.ToString());
            GameObject brushObj;
            if (mode == TexturePainter_BrushModev2.PAINT)
            {
    ...
    bool HitTestUVPosition(ref Vector3 uvWorldPosition)
    {
...

        {
            ...
            Debug.Log("Physics.Raycast hit target object. " + hit.ToString());
    ...
    public void SetBrushMode(TexturePainter_BrushModev2 brushMode)
    { //Sets if we are painting or placing decals
        mode = brushMode;
        brushCursor.GetComponent<SpriteRenderer>().sprite = brushMode == TexturePainter_BrushModev2.PAINT ? cursorPaint : cursorDecal;
    }
